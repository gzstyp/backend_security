...
public final class ConfigFile implements Serializable{
    ...
    public final static String[] IGNORE_URLS = {"/","/error",URL_LOGIN_PAGE,URL_REGISTER,URL_PROCESSING,"/user/renewalToken","/**/notAuthorized","/user/logout","/bootstrap/**","/*.ico","/css/**","/images/**","/js/**","/webjars/**","/swagger/**","/v2/api-docs","/swagger-ui.html","/swagger-resources/**","/v1.0/**","/v2/**","/images/**","/avatars/**","/fonts/**","/img/**"};
